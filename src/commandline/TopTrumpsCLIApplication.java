...
public class TopTrumpsCLIApplication {
        ...
        private void UserPicking() {
            ...
            if(isNumeric(entradaTeclado)){
                switch (entradaTeclado) {
                    case "1":playRound(1);break;
                    case "2":playRound(2);break;
                    case "3":playRound(3);break;
                    case "4":playRound(4);break;
                    case "5":playRound(5);break;
                    default:
	...
	private void playRound(int trumpIndex) {
	    ...
	    this.prevRoundString = Round.getRoundString();
